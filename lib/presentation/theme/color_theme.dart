...
class ColorTheme {
  ...
  // generate 'primary' like warning but the main color is #0A6847

  // Generated 'primary' color with a similar approach as 'warning'
  static const primary = MaterialColor(
    0xFF0A6847,
    <int, Color>{
      50: Color(0xffE6F3EB),
      100: Color(0xffCDE6D7),
      200: Color(0xffB3D9C4),
      300: Color(0xff99CBB0),
      400: Color(0xff7FBF9D),
      500: Color(0xFF0A6847),
      600: Color(0xff0D5C3F),
      700: Color(0xff0F5137),
      800: Color(0xff11452F),
      900: Color(0xff113927),
    },
  );
